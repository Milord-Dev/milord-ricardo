    ...
    const App = {
        ...
        methods: {
            ...
            renderProductCard(product) {
                ...
                productCard.querySelector('.view-btn').addEventListener('click', () => App.methods.viewProduct(product.id));
                productCard.querySelector('.edit-btn').addEventListener('click', () => App.methods.editProduct(product.id));
                productCard.querySelector('.delete-btn').addEventListener('click', () => App.methods.deleteProduct(product.id));
            ...
            async editProduct(id) {
                try {
                    ...
                    App.htmlElements.productIdInput.value = product.id;
                    ...
                    App.htmlElements.productForm.scrollIntoView({ behavior: 'smooth' });
                } catch (error) {
            ...
            async viewProduct(id) {
                try {
                    ...
                    App.htmlElements.detailId.textContent = product.id;
